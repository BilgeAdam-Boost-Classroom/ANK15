...
namespace NorthwindDBFrist.Models
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        public virtual DbSet<Gorev1> Gorev1s { get; set; } = null!;
        public virtual DbSet<Gorev2> Gorev2s { get; set; } = null!;
        public virtual DbSet<Gorev3> Gorev3s { get; set; } = null!;
        public virtual DbSet<Gorev4> Gorev4s { get; set; } = null!;
        public virtual DbSet<Gorev5> Gorev5s { get; set; } = null!;
        public virtual DbSet<Gorev6> Gorev6s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=ANK2-YZLMORT-10;Database=NORTHWND;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Gorev1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev1");
            ...
            modelBuilder.Entity<Gorev2>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev2");
            ...
            modelBuilder.Entity<Gorev3>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev3");
            ...
            modelBuilder.Entity<Gorev4>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev4");
            ...
            modelBuilder.Entity<Gorev5>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev5");

                entity.Property(e => e.ProductName).HasMaxLength(40);
            });

            modelBuilder.Entity<Gorev6>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Gorev6");
