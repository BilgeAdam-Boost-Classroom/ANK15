...
namespace LINQOrnekler.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Hesaplar> Hesaplars { get; set; } = null!;
        public virtual DbSet<Invoice> Invoices { get; set; } = null!;
        public virtual DbSet<IslemTurleri> IslemTurleris { get; set; } = null!;
        public virtual DbSet<IslemYerleri> IslemYerleris { get; set; } = null!;
        ...
        public virtual DbSet<Paralar> Paralars { get; set; } = null!;
        public virtual DbSet<Product> Products { get; set; } = null!;
        public virtual DbSet<ProductCategoriesLeftJoin> ProductCategoriesLeftJoins { get; set; } = null!;
        public virtual DbSet<ProductCategoryFullJoin> ProductCategoryFullJoins { get; set; } = null!;
        public virtual DbSet<ProductCategoryInnerJoin> ProductCategoryInnerJoins { get; set; } = null!;
        public virtual DbSet<ProductCategoryRightJoin> ProductCategoryRightJoins { get; set; } = null!;
        public virtual DbSet<ProductGetNullCategoryLeftJoin> ProductGetNullCategoryLeftJoins { get; set; } = null!;
        public virtual DbSet<ProductGetNullCategoryRightJoin> ProductGetNullCategoryRightJoins { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-VUKATPV;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hesaplar>(entity =>
            {
                ...
                entity.HasOne(d => d.Musteri)
                    .WithMany(p => p.Hesaplars)
                    .HasForeignKey(d => d.MusteriId)
                    .HasConstraintName("FK__Hesaplar__Muster__1BC821DD");
            });
            ...
            modelBuilder.Entity<IslemTurleri>(entity =>
            {
                entity.ToTable("IslemTurleri");

                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.IslemTuru).HasMaxLength(30);
            });

            modelBuilder.Entity<IslemYerleri>(entity =>
            {
                entity.ToTable("IslemYerleri");

                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.IslemYeri).HasMaxLength(30);
            });

            modelBuilder.Entity<Musteriler>(entity =>
            {
                entity.HasKey(e => e.MusteriId)
                    .HasName("PK__Musteril__72624471971A28A0");
            ...
            modelBuilder.Entity<Paralar>(entity =>
            {
                entity.HasKey(e => e.ParaBirimId)
                    .HasName("PK__Paralar__DB571AE93A89A5FE");

                entity.ToTable("Paralar");

                entity.Property(e => e.ParaBirimId).HasColumnName("ParaBirimID");

                entity.Property(e => e.ParaTipi).HasMaxLength(10);
            });
            ...
            modelBuilder.Entity<ProductCategoriesLeftJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductCategoriesLeftJoin");
            ...
            modelBuilder.Entity<ProductCategoryFullJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductCategoryFullJoin");
            ...
            modelBuilder.Entity<ProductCategoryInnerJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductCategoryInnerJoin");
            ...
            modelBuilder.Entity<ProductCategoryRightJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductCategoryRightJoin");
            ...
            modelBuilder.Entity<ProductGetNullCategoryLeftJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductGetNullCategoryLeftJoin");
            ...
            modelBuilder.Entity<ProductGetNullCategoryRightJoin>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductGetNullCategoryRightJoin");
            ...
            modelBuilder.Entity<Sehirler>(entity =>
            {
                ...
                entity.Property(e => e.SehirAd).HasMaxLength(30);
            });
            ...
            modelBuilder.Entity<Subeler>(entity =>
            {
                entity.HasKey(e => e.SubeId)
                    .HasName("PK__Subeler__C30410194981661B");
                ...
                entity.HasOne(d => d.Sehir)
                    .WithMany(p => p.Subelers)
                    .HasForeignKey(d => d.SehirId)
                    .HasConstraintName("FK__Subeler__SehirID__151B244E");
            });
